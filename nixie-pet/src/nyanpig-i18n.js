...
(function() {
    ...
    var NIXIE_I18N = {
        zh: {
            ...
            'menu.pet_settings': '宠物设置',
            'pet.settings.title': 'Pet Selector',
            'pet.settings.name_label': '宠物名字',
            'pet.settings.body_label': '体型',
            'pet.settings.locale_label': '语言',
            'pet.settings.breed_label': '品种',
            'pet.settings.body.normal': '普通',
            'pet.settings.body.small': '小型（80%）',
            'pet.settings.body.mini': '迷你（50%）',
            'pet.settings.locale.zh': '中文',
            'pet.settings.locale.en': 'English',
            'pet.settings.locale.ja': '日本語',
            'pet.settings.locale.binary': 'BINARY',
            'pet.settings.breed.virtual_pig': '虚拟猪',
            'pet.settings.save': '保存',
            'pet.settings.cancel': '取消',
            'pet.settings.reset': '恢复默认',
            'pet.settings.tag_lvl': 'LVL 01',
            'pet.settings.tag_mood': 'HAPPY',
            'pet.settings.help_toast': '设置保存在配置目录下的 pet_settings.json。体型只缩小猪猪与彩虹拖尾，台词与点击判定区域不变。',
            'menu.about': '关于小猪…',
            'menu.quit': '安全退出小猪',
        ...
        en: {
            ...
            'menu.pet_settings': 'Pet settings',
            'pet.settings.title': 'Pet Selector',
            'pet.settings.name_label': 'Pet name',
            'pet.settings.body_label': 'Body size',
            'pet.settings.locale_label': 'Language',
            'pet.settings.breed_label': 'Breed',
            'pet.settings.body.normal': 'Normal',
            'pet.settings.body.small': 'Small (80%)',
            'pet.settings.body.mini': 'Mini (50%)',
            'pet.settings.locale.zh': '中文',
            'pet.settings.locale.en': 'English',
            'pet.settings.locale.ja': '日本語',
            'pet.settings.locale.binary': 'BINARY',
            'pet.settings.breed.virtual_pig': 'VIRTUAL_PIG',
            'pet.settings.save': 'Save',
            'pet.settings.cancel': 'Cancel',
            'pet.settings.reset': 'Reset',
            'pet.settings.tag_lvl': 'LVL 01',
            'pet.settings.tag_mood': 'HAPPY',
            'pet.settings.help_toast': 'Settings are saved as pet_settings.json in the config folder. Body size only shrinks the pet and rainbow trail; speech and hit areas stay the same.',
            'menu.about': 'About…',
        ...
        ja: {
            ...
            'menu.pet_settings': 'ペット設定',
            'pet.settings.title': 'Pet Selector',
            'pet.settings.name_label': '名前',
            'pet.settings.body_label': '体型',
            'pet.settings.locale_label': '言語',
            'pet.settings.breed_label': '品種',
            'pet.settings.body.normal': '普通',
            'pet.settings.body.small': '小型（80%）',
            'pet.settings.body.mini': 'ミニ（50%）',
            'pet.settings.locale.zh': '中文',
            'pet.settings.locale.en': 'English',
            'pet.settings.locale.ja': '日本語',
            'pet.settings.locale.binary': 'BINARY',
            'pet.settings.breed.virtual_pig': 'バーチャルブタ',
            'pet.settings.save': '保存',
            'pet.settings.cancel': 'キャンセル',
            'pet.settings.reset': '初期値に戻す',
            'pet.settings.tag_lvl': 'LVL 01',
            'pet.settings.tag_mood': 'HAPPY',
            'pet.settings.help_toast': '設定は設定フォルダ内の pet_settings.json に保存されます。体型はブタと虹の軌跡だけ縮小し、セリフとクリック判定は変わりません。',
